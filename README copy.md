...
[Working Application - Deployed](https://beulah-supercode.netlify.app/)

- beulah-supercode-html - working html/css/javascript project (contains assets)
...
```sh
npx create-react-app@latest beulah-supercode
```
...
// JSX
<img src={logo} className="nav-logo" alt="Beulah Supercode" />;
```
